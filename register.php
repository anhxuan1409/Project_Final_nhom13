                                            ...
                                            <form class="mx-1 mx-md-4" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="d-flex flex-row align-items-center mb-4">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <input type="file" id="fileToUpload" name="fileToUpload" class=" mb-3 form-control" >
...
if (isset($_POST['submit'])) {
    ...
    $target_dir = "./administrators/img/"; //chỉ định thư mục nơi tệp sẽ được đặt
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        if ($res2 > 0) {
            ...
            try {
                ...
                $mail->Username = 'ngctrngnh@gmail.com'; // SMTP username
                $mail->Password = 'lxozjkdnrcsxjhcb'; // SMTP password
                $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS; // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` also accepted
                $mail->Port = 587; // TCP port to connect to
                $mail->CharSet = 'UTF-8';
                //Recipients
                $mail->setFrom('ngctrngnh@gmail.com', 'FOODY');

                $mail->addReplyTo('ngctrngnh@gmail.com', 'FOODY');
                ...
                $mail->Subject = $tieude;
                // gui ve thong bao                   
                $linkemail = "http://localhost/Project_Final_nhom13/active_user.php?email=" . $email . "&code=" . $code;
                // Mail body content 
                $bodyContent .= '<p><b>Hãy xác nhận email đăng ký tài khoản</b></p>';
